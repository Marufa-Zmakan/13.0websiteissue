odoo.define('pragmatic_check_warehouse_stock.VariantMixin', function (require) {
'use strict';
...
var xml_load = ajax.loadXML(
    '/pragmatic_check_warehouse_stock/static/src/xml/website_sale_stock_product_availability.xml',
    QWeb
);
...
VariantMixin._onChangeCombinationStock = function (ev, $parent, combination) {
    ...
    if (combination.product_type === 'product' && _.contains(['always_allow'], combination.inventory_availability)) {

            combination.virtual_available=combination.qty_available;
            combination.virtual_available -= parseInt(combination.cart_qty);

            // add the stock_buffer qty
            combination.stock_buffer_qty = combination.stock_buffer;
